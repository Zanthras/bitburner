...
export async function CopyFiles(ns, node) {
    ...
    await ns.scp(["/module/helper-functions.js", "/module/node-functions.js", "/module/script-functions.js", "/module/stack-functions.js"], "home", node)
    await ns.scp(["/background/fixup.js", "/background/mass-fix.js", "/background/idle.js"], "home", node)
}
